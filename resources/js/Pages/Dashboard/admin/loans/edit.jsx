...
const AdminLoanEdit = ({ loan, clients, collectors, auth }) => {
    const { data, setData, put, processing, errors, reset } = useForm({
        client_profile_id: loan.client_profile_id || "",
        collector_profile_id: loan.collector_profile_id || "",
        amount: loan.amount || "",
                            ...
                            >
                                ...
                                {clients.map((client) => (
                                    <option
                                        ...
                                        value={client.id}
                                        selected={
                                            client.id === loan.client_profile_id
                                        }
                                    >

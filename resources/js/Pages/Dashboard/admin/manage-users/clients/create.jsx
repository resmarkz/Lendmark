...
const AdminManageClientsCreate = ({ auth }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.manage-users.clients.store"), {
            onSuccess: () => reset(),
            preserveScroll: true,
        });
    };
...
AdminManageClientsCreate.layout = (page) => (
    <DashboardLayout children={page} auth={page.props.auth} />
);

export default AdminManageClientsCreate;
